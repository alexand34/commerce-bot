...
namespace commerce_bot_mvc.Controllers
{
    public class FoodCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FoodCategoryName,FoodCategoryFrenchName")] FoodCategory foodCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FoodCategoryName,FoodCategoryFrenchName")] FoodCategory foodCategory)
        {
            if (ModelState.IsValid)
            {
